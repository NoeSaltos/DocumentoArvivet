...
\begin{document}
	...
	\chapter{Project Planning and Risk Management}
	\section{Risk Management}
	
	\begin{longtable}{|p{0.5cm}|p{3cm}|p{2cm}|p{2cm}|p{4cm}|p{4cm}|}
		\hline
		\textbf{ID} & \textbf{Risk Name} & \textbf{Probability of Occurrence} & \textbf{Level of Impact} & \textbf{Strategy} & \textbf{Action to be Taken} \\
		\hline
		1 & Lack of experienced resources & High & Serious Threat & Recruit quality personnel, provide training & Develop a training plan  \\
		\hline
		2 & Poorly defined requirements & Probable & Major Obstacle & Requirement engineering techniques, prototypes, evolutionary lifecycle & Conduct workshops for clear requirements, iterative prototyping \\
		\hline
		4 & Issues with external software resources & Probable & Major Obstacle & Contracting skills, benchmarking, inspection & Establish clear contracts, conduct benchmarks, and perform regular inspections \\
		\hline
		5 & Poor iterative development management & Medium & Major Obstacle & Project management training, time control & Implement strict time control and provide project management training \\
		\hline
		7 & Poor design leads to performance issues & Probable & Serious Threat & Simulation, benchmarking, prototyping & Perform simulations, iterative prototyping, and design reviews \\
		\hline
		8 & Poor reporting, risk management, and quality control & High & Serious Threat & Change control, software reuse, incremental development, project management training & Implement a robust change management process and incremental development \\
		\hline
		9 & Remote team location causes implementation issues & Probable & Major Obstacle & Video conferencing, project websites, team collaboration tools & Use video conferencing tools and enable remote collaboration \\
		\hline
		10 & Poor testing strategy causes system reliability issues & Probable & Serious Threat & Simulation, benchmarking, prototyping & Develop a comprehensive testing strategy, perform benchmarks, and simulate scenarios \\
		\hline
		\caption{Risk Management Table for ARVIVET \label{tab:arvivet_risk_management}}
	\end{longtable}
